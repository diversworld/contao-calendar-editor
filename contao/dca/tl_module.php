...
$GLOBALS['TL_DCA']['tl_module']['palettes']['calendarEdit'] = $GLOBALS['TL_DCA']['tl_module']['palettes']['calendar'] . ';{edit_legend},cal_template,caledit_add_jumpTo; {edit_holidays},cal_holidayCalendar';
...
(
    ...
    'inputType'               => 'checkbox',
    'eval' => ['submitOnChange' => true, 'tl_class' => 'clr m12 w50'],
    'sql'					  => "char(1) NOT NULL default ''"
);
...
(
    ...
    'default' => 'frontend_module/eventEdit_default',
    'exclude' => true,
    'inputType'               => 'select',
...
(
    ...
    'default' => 'frontend_module/eventEdit_duplicate',
    'exclude' => true,
    'inputType'               => 'select',
    'options_callback' => [ModuleDca::class, 'getEventEditTemplates'],
...
(
    ...
    'default' => 'frontend_module/eventEdit_delete',
    'exclude' => true,
    'inputType'               => 'select',
    'options_callback' => [ModuleDca::class, 'getEventEditTemplates'],
    'eval' => ['tl_class' => 'w50', 'chosen' => true],
...
(
    ...
    'default' => 'frontend_module/cal_default_edit',
    'exclude' => true,
    'inputType' => 'select',
    'options_callback' => [ModuleDca::class, 'getCalendarTemplates'],
    'eval' => ['tl_class' => 'w50', 'chosen' => true],
    'sql' => "varchar(255) NOT NULL default ''"
);
...
(
    ...
    'exclude'                 => true,
    'inputType'               => 'checkbox',
    'options_callback' => [ModuleDca::class, 'getCalendars'],
...
(
    ...
    'exclude'                 => true,
    'inputType'               => 'select',
    'options' => ['all', 'ltToday', 'leToday', 'geToday', 'gtToday'],
...
(
    ...
    'default'                 => 'smoothness',
    'inputType'               => 'select',
    'options' => ["black-tie", "blitzer", "cupertino", "dark-hive", "dot-luv", "eggplant", "excite-bike", "flick", "hot-sneaks", "humanity", "le-frog", "mint-choc", "overcast", "pepper-grinder", "redmond", "smoothness", "south-street", "start", "sunny", "swanky-purse", "trontastic", "ui-darkness", "ui-lightness", "vader"],
